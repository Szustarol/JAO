...
public class DebugStatus {
    ...
    private static String getShortenInt(Long n) {
    ...
    void printStatus() {
        ...
        System.out.println(this.name + " | id [" + id + "] | actions [" + getShortenInt((long)entries.size()) +"] | units of work done [" + getShortenInt(status.unitsOfWork) + "]");
    }
}
