...
public class TestParameters {
    ...
    public static TestParameters randomTest(int bufferSize, int consumers, int consumersWorkUnits, int producers, int producersWorkUnits, int insertionWorkUnits, int pollWorkUnits) {
        ...
        test.insertionWorkUnits = ThreadLocalRandom.current().nextInt(1, insertionWorkUnits + 1);
        test.producers = ThreadLocalRandom.current().nextInt(1, producers + 1);
        test.pollWorkUnits = ThreadLocalRandom.current().nextInt(1, pollWorkUnits + 1);
        return test;
    }
